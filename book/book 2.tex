...
\protect\hypertarget{exm:unnamed-chunk-1}{}{(\#exm:unnamed-chunk-1)
}J'aim bien les exemples \EndKnitrBlock{example}
...
\textbf{bookdown} package (\protect\hyperlink{ref-R-bookdown}{Xie 2021})
in this sample book, which was built on top of R Markdown and
\textbf{knitr} (\protect\hyperlink{ref-xie2015}{Xie 2015}).
