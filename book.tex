...
emzfe \BeginKnitrBlock{theorem}
\protect\hypertarget{thm:unnamed-chunk-1}{}{(\#thm:unnamed-chunk-1)
}Here is my theorem. \EndKnitrBlock{theorem}
...
\protect\hypertarget{def:unnamed-chunk-2}{}{(\#def:unnamed-chunk-2) }Un
court circuit est un circuit court.. \EndKnitrBlock{definition}
...
Et voici une équation inline \(E=mc^2\). Affichage d'un résultat avec SI
units: \(\SI{3.2e12}{\kilo\gram\per\second}\). Ne fonctionne pas en
HTML..

Equation en ligne \[2x  = 3 -\sqrt{2}\] \begin{align}
x &= 2x +5 \\
-x &= 5 \\
x &= -5 
\end{align}
...
En modifiant la largeur: 200px \includegraphics{figures/fig.png}\{
width: 200px; \}
